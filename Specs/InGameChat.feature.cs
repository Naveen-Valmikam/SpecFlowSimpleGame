...
#line hidden
        ...
        public static void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "InGameChat", "\tIn order to increase the sense of the game\r\n\tAs a humar player\r\n\tI want to be ab" +
                    "le to chat via text with other human players", ProgrammingLanguage.CSharp, new string[] {
